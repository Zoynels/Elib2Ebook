...
| -f, --format             | Обязательное. Формат для сохранения книги. Допустимые значения: epub, fb2, cbz, json, json_chapter, txt |
...
| --use-cache-dir          | Сохранить запросы на диск и использовать сохраненное как кэш                                            |
| --book-name              | Установить имя файла для сохранения книги, иначе имя файла будет рассчитано автоматически               |
| --sleep-between-requests | Timeout в секундах между запросами в интернет                                                           |
